    ...
    <fragment>
        <tr v-show="!isEditing">
            ...
            <td class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                <svg @click="isEditing = ! isEditing" xmlns="http://www.w3.org/2000/svg"
        ...
        <tr v-show="isEditing">
            ...
            <td class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                ...
                <div class="flex space-x-2 items-center " v-show="isEditing" @click="isEditing = ! isEditing">
                <button @click="updateProduct" :disabled="disabled"
                      class=" cursor-pointer  rounded-md px-2 py-2 text-white bg-blue-400 disabled:bg-gray-400">SAVE
                </button>
                </div>
            </td>
            <td
