<template>
    <form  @submit.prevent="onSubmit">
        ...
        <div class="form-group mb-6">
            ...
            <input type="text" name="description" v-model="description"  class="form-control block
        w-full
        px-3
        py-1.5
        text-base
        ...
        <div class="form-group mb-6">
            ...
            <input type="text" name="price" v-model="price"  class="form-control block
        w-full
        px-3
        py-1.5
        text-base
